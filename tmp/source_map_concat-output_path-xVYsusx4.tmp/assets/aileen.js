      ...
      addMedia: function addMedia(projectID) {
        ...
        newImage.save().then(function () {
          project.save().then(function () {
            ...
            self.transitionToRoute('work.edit.project.edit');
          });
        });
      },
